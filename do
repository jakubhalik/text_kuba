...
they are very much the same with the difference of passing different arguments for username and for setError, maybe there are others I don't see right now, I need to create like a function that I will just be calling with different properties for those 2 cases so I do not have such a big repetition
