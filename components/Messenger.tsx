          ...
          <div className="flex-1 grid gap-4 p-4">
            <div className="flex items-start">
              <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-900">
                <p>
                  Hey, did you want to meet up for lunch today? I heard about
                  this new place that opened up downtown.
                </p>
              </div>
            ...
            <div className="flex items-start">
              <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-900">
                <p>Awesome! Let's meet at the entrance of the mall at 1 PM.</p>
              </div>
              <span className="text-sm text-gray-500 self-end ml-2 dark:text-gray-400">
                2:35 PM
              </span>
